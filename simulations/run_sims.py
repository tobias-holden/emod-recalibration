...
def submit_sim(site=None, nSims=1, characteristic=False, priority=manifest.priority, my_manifest=manifest,
    ...
    platform1 = Platform("SLURM_LOCAL", job_directory=manifest.job_directory, partition='b1139', time='8:00:00', 
                            account='b1139', modules=['singularity'], max_running_jobs=200, mem=4000, c=4)
    ...
    submit_scheduled_analyzer(experiment, platform1, site, analyzer_script='run_analyzers.py', mem=40000)
