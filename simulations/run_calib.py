...
problem = Problem(workdir="output/9Site_2")
...
tts = TurboThompsonSampling(batch_size=100, n_candidates=10000, failure_tolerance=4, dim=problem.dim) #64
