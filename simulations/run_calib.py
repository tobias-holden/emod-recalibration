...
output_dir = "output/9Sites"
#best_dir = "checkpoints/9Sites" 
...
problem = Problem(workdir="output/9Sites")
...
tts = TurboThompsonSampling(batch_size=64, n_candidates=10000, failure_tolerance=4, dim=problem.dim) #64
...
# Create the workflow
bo = BO(problem=problem, model=model, batch_generator=batch_generator, checkpointdir=output_dir, max_evaluations=128)

# Sample and evaluate sets of parameters randomly drawn from the unit cube

#bo.initRandom(2)

#bo.initRandom(2, n_batches = 1, Xpriors = [[0.000000000765, 0.2, 0.002, 0.0615,
#                                           0.708785, 0.77282, 0.635, 0.5183, 0.5886,
#                                           0.15, 0.511735322,
#                                           0.005, 0.4151, 0.5, 0]])

# bo.initRandom(2000, n_batches = 20, Xpriors = [[0.000000000765, 0.2, 0.002, 0.0615,
#                                            0.708785, 0.77282, 0.635, 0.5183, 0.5886,
#                                            0.15, 0.511735322,
#                                            0.005, 0.4151, 0.5, 0]])
                                            
bo.initRandom(64, n_batches = 1, Xpriors = [[0.000000000765, 0.2, 0.002, 0.0615,
                                           0.708785, 0.77282, 0.635, 0.5183, 0.5886,
                                           0.15, 0.511735322,
                                           0.005, 0.4151, 0.5, 0]])                                          
